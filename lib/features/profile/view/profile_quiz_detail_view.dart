...
class ProfileQuizDetailView extends GetView<ProfileQuizDetailController> {
  ...
  Map<String, VoidCallback> _voiceCommands(
    ...
    return {
      ...
      'sebelumnya': () => controller.previousQuestion(questions.length),
      'kembali': () => controller.previousQuestion(questions.length),
      'jawab a': () => controller.answerCurrentByLabel('a', questions),
      'jawab b': () => controller.answerCurrentByLabel('b', questions),
      'jawab c': () => controller.answerCurrentByLabel('c', questions),
      'jawab d': () => controller.answerCurrentByLabel('d', questions),
      'jawab e': () => controller.answerCurrentByLabel('e', questions),
      'jawaban a': () => controller.answerCurrentByLabel('a', questions),
      'jawaban b': () => controller.answerCurrentByLabel('b', questions),
      'jawaban c': () => controller.answerCurrentByLabel('c', questions),
      'jawaban d': () => controller.answerCurrentByLabel('d', questions),
      'jawaban e': () => controller.answerCurrentByLabel('e', questions),
      'pilih a': () => controller.answerCurrentByLabel('a', questions),
      'pilih b': () => controller.answerCurrentByLabel('b', questions),
      'pilih c': () => controller.answerCurrentByLabel('c', questions),
      'pilih d': () => controller.answerCurrentByLabel('d', questions),
      'pilih e': () => controller.answerCurrentByLabel('e', questions),
      'opsi a': () => controller.answerCurrentByLabel('a', questions),
      'opsi b': () => controller.answerCurrentByLabel('b', questions),
      'opsi c': () => controller.answerCurrentByLabel('c', questions),
      'opsi d': () => controller.answerCurrentByLabel('d', questions),
      'opsi e': () => controller.answerCurrentByLabel('e', questions),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: compact ? 8 : 12),
          Expanded(
            child: tipe == 'pilihan' || tipe == 'listening'
  ...
  Widget _optionsGrid(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final itemHeight =
            ((constraints.maxHeight - (gap * (options.length - 1))) /
                    options.length)
                .clamp(30.0, compact ? 54.0 : 66.0);
        return Column(
